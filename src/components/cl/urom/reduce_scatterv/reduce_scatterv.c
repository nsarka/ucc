...
ucc_base_coll_alg_info_t
    ucc_cl_urom_reduce_scatterv_algs[UCC_CL_UROM_REDUCE_SCATTERV_ALG_LAST + 1] = {
        [UCC_CL_UROM_REDUCE_SCATTERV_ALG_FULL] =
            {.id   = UCC_CL_UROM_REDUCE_SCATTERV_ALG_FULL,
             .name = "urom_full_offload",
             .desc = "full offload of reduce_scatterv"},
...
ucc_status_t ucc_cl_urom_reduce_scatterv_triggered_post_setup(ucc_coll_task_t *task)
{
    return UCC_OK;
}
...
static ucc_status_t ucc_cl_urom_reduce_scatterv_full_start(ucc_coll_task_t *task)
{
    ...
    //size_t src_count = 0;
    size_t dst_count = coll_args->src.info.count;
...
static ucc_status_t ucc_cl_urom_reduce_scatterv_full_finalize(ucc_coll_task_t *task)
{
    ucc_cl_urom_schedule_t *schedule =
        ucc_derived_of(task, ucc_cl_urom_schedule_t);
    ucc_status_t status;
...
static void ucc_cl_urom_reduce_scatterv_full_progress(ucc_coll_task_t *ctask)
{
                         ...
                         ucc_coll_task_t **task)
{
    ...
    schedule->super.post           = ucc_cl_urom_reduce_scatterv_full_start;
    schedule->super.progress       = ucc_cl_urom_reduce_scatterv_full_progress;
    schedule->super.finalize       = ucc_cl_urom_reduce_scatterv_full_finalize;
    schedule->super.triggered_post = ucc_triggered_post;
    schedule->super.triggered_post_setup =
        ucc_cl_urom_reduce_scatterv_triggered_post_setup;
